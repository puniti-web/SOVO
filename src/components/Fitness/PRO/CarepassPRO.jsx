    ...
    return (
        ...
        <Flex 
            ...
            >
                    ...
                    <List fontSize="1.5rem" color="whiteAlpha.700" fontWeight="bold">
                        <ListItem>
                            <Flex gap="2" alignItems="center">
                                ...
                                <Text color="whiteAlpha.700"  fontSize="1.5rem">AI workout tracking</Text>
                            </Flex>                            
                        </ListItem>
                        ...
                        {/* <ListItem>
                            <Flex gap="2" alignItems="center">
                                <CheckIcon color="red.400" border="1px" padding="2px" borderRadius="50%" />
                                <Text color="whiteAlpha.700"  fontSize="1.5rem"> At</Text>
                            </Flex>                           
                        </ListItem> */}
                        ...
                        <ListItem>
                            <Flex gap="2" alignItems="center">
                                <CheckIcon color="red.400" border="1px" padding="2px" borderRadius="50%" />
                                <Text color="whiteAlpha.700"  fontSize="1.5rem">2 sessions/month with other users</Text>
                            </Flex>
                ...
                <Box w={{md:"52%"}}>
                    <Image borderRadius="20px" src="https://stayfitcentral.com/wp-content/uploads/2024/07/Man-And-Woman-Creating-Workout-With-AI-Endura-Chatbot-Personal-Trainer.jpg" />
