...
const images1 = [
    {url:"https://cdn.prod.website-files.com/5ecf8d4fd463368e57125560/5ecf8d4fd4633682fd125584_feature-1.png"},
    {url:"https://cdn.prod.website-files.com/5ecf8d4fd463368e57125560/5ecf8d4fd463363660125583_feature-2.png"},
];



export const CarepassTransform = () => {
        ...
        <Box 
           w="80%" 
            ...
            >
                ...
                <Box>
                    <Image src="https://bestayla.com/wp-content/uploads/2024/09/AI-Powered-Fitness-Interface-in-a-Futuristic-Gym.jpeg.webp" />
                </Box>
                ...
                textAlign="left">
                    <Heading fontSize="5xl">
                        carepass <Text as="span" color="orange.300">Transform</Text>
                    </Heading>
                    <Heading fontSize="5xl">
                    Unlimited access to
                    </Heading>
