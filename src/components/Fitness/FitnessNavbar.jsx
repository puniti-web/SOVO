        ...
        <Show above="md">
            ...
            colorScheme="gray">
                <TabList padding="10px"  bgColor="#393A3B">
                    {/* <Tab></Tab> */}
                    <Tab color="whiteAlpha.800">SOVO ELITE</Tab>
                    <Tab color="whiteAlpha.800">SOVO PRO</Tab>
                    <Tab color="whiteAlpha.800">SOVO Home</Tab>
                    <Tab color="whiteAlpha.800">SOVO Transform</Tab>
